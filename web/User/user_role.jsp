...
<%
  ...
  sql="select role_id,role_name from d_role where role_id not in(select role_id from D_USER_ROLE where user_id ="+id+")";
  String userNoFun[][]=e.getSelectResultWithStringArray(sql);

  sql="select role_id,role_name from d_role where role_id in(select role_id from D_USER_ROLE where user_id ="+id+")";
...
<table width="667" border="0" align="center" >
  <tr>
    <td width="657" height="116" background="../images/333.gif">      <h1 align="center" class="style12">权限管理系统</h1>      <p align="center" class="style10"> --员工角色管理</p></td></tr>
</table>
<form action="../Common/FormReceiveJSP_forRight.jsp?choose=13" method="post" name="form1">
    ...
    <table width="383" border="0" bgcolor="#C4CAE1">
      ...
      <tr>
        <td width="154" height="47"><div align="center">
          <p align="left"><strong>员工没有的角色</strong></p>
        </div></td>
        <td width="53">&nbsp;</td>
        <td width="154"><div align="center">
          <p align="left"><strong>员工拥有的角色</strong></p>
        </div></td>
      </tr>
      <tr>
