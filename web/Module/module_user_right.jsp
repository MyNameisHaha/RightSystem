...
<%
  ...
  sql="select user_id,user_name from d_user where org_id ="+userDep+" and user_id not in(select d_user.user_id from d_user,D_R_USERMODULE where d_user.user_id=D_R_USERMODULE.user_id and module_id="+id+" and org_id="+userDep+")";
  String noFunUser[][]=e.getSelectResultWithStringArray(sql);
  sql="select d_user.user_id,user_name from d_user,D_R_USERMODULE where d_user.user_id=D_R_USERMODULE.user_id and module_id="+id+" and org_id="+userDep;
...
<form action="../Common/FormReceiveJSP_forRight.jsp?choose=4" method="post" name="form1">
    ...
    <table width="383" border="0" bgcolor="#C4CAE1">
      ...
      <tr>
        <td width="154" height="47"><div align="center">
          <p align="left"><strong>没有模块权限的员工</strong></p>
        </div></td>
        <td width="53">&nbsp;</td>
        <td width="154"><div align="center">
          <p align="left"><strong>拥有模块权限的员工</strong></p>
        </div></td>
      </tr>
      <tr>
