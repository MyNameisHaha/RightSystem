...
<%
  ...
  sql="select role_id,role_name from d_role where org_id ="+userDep+" and role_id not in(select d_role.role_id from d_role,D_R_ROLE_MODULE where d_role.role_id=D_R_ROLE_MODULE.role_id and module_id="+id+" and org_id="+userDep+")";
  String noFunUser[][]=e.getSelectResultWithStringArray(sql);
  sql="select d_role.role_id,role_name from d_role,D_R_ROLE_MODULE where d_role.role_id=D_R_ROLE_MODULE.role_id and module_id="+id+" and org_id="+userDep;
...
<table width="667" border="0" align="center" >
  <tr>
    <td width="657" height="116" background="../images/333.gif">      <h1 align="center" class="style12">权限管理系统</h1>      <p align="center" class="style10"> --角色模块管理</p></td></tr>
</table>
<form action="../Common/FormReceiveJSP_forRight.jsp?choose=5" method="post" name="form1">
  <input type="hidden" name="id" value=<%=id%>>
  <div align="center">
    <p class="style30">当前模块:<%=functionname[0][0]%></p>
    <table width="383" border="0" bgcolor="#C4CAE1">
      ...
      <tr>
        <td width="154" height="47"><div align="center">
          <p align="left"><strong>没有模块权限的角色</strong></p>
        </div></td>
        <td width="53">&nbsp;</td>
        <td width="154"><div align="center">
          <p align="left"><strong>拥有模块权限的角色</strong></p>
        </div></td>
      </tr>
      <tr>
