...
<%
  ...
  sql="select role_id,role_name from d_role where org_id ="+userDep+" and role_id not in(select d_role.role_id from d_role,D_R_ROLE_FUN where d_role.role_id=D_R_ROLE_FUN.role_id and function_id="+id+" and org_id="+userDep+")";
  String noFunUser[][]=e.getSelectResultWithStringArray(sql);
  sql="select d_role.role_id,role_name from d_role,D_R_ROLE_FUN where d_role.role_id=D_R_ROLE_FUN.role_id and function_id="+id+" and org_id="+userDep;
...
<form action="../Common/FormReceiveJSP_forRight.jsp?choose=3" method="post" name="form1">
    ...
    <table width="383" border="0" bgcolor="#C4CAE1">
      ...
      <tr>
        <td width="154" height="47"><div align="center">
          <p align="left"><strong>没有功能权限的角色</strong></p>
        </div></td>
        <td width="53">&nbsp;</td>
        <td width="154"><div align="center">
          <p align="left"><strong>拥有功能权限的角色</strong></p>
        </div></td>
      </tr>
      <tr>
