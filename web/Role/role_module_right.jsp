...
<%
  ...
  sql="select module_id,module_name from d_module where module_id not in(select module_id from d_r_role_module where role_id ="+id+")";
  String userNoFun[][]=e.getSelectResultWithStringArray(sql);

  sql="select module_id,module_name from d_module where module_id in(select module_id from d_r_role_module where role_id ="+id+")";
...
<form action="../Common/FormReceiveJSP_forRight.jsp?choose=8" method="post" name="form1">
    ...
    <table width="383" border="0" bgcolor="#C4CAE1">
      ...
      <tr>
        <td width="154" height="47"><div align="center">
          <p align="left"><strong>角色没有权限的模块</strong></p>
        </div></td>
        <td width="53">&nbsp;</td>
        <td width="154"><div align="center">
          <p align="left"><strong>角色拥有权限的模块</strong></p>
        </div></td>
      </tr>
      <tr>
