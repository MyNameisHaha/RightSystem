...
<%
  ...
  sql="select function_id,function_name from d_function where function_id not in(select function_id from D_R_FUN_MANAGER where manager_id ="+id+")";
...
<form action="../Common/FormReceiveJSP_forRight.jsp?choose=11" method="post" name="form1">
    ...
    <table width="383" border="0" bgcolor="#C4CAE1">
      ...
      <tr>
        <td width="154" height="47"><div align="center">
          <p align="left"><strong>管理员没有权限的功能</strong></p>
        </div></td>
        <td width="53">&nbsp;</td>
