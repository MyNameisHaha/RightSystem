...
<%
  ...
  String sql="select role_name from d_role where role_id="+id;
  exeQueryResult e = new exeQueryResult();
  String rolename[][]=e.getSelectResultWithStringArray(sql);

  sql="select function_id,function_name from d_function where function_id not in(select function_id from d_r_role_fun where role_id ="+id+")";
  String userNoFun[][]=e.getSelectResultWithStringArray(sql);

  sql="select function_id,function_name from d_function where function_id in(select function_id from d_r_role_fun where role_id ="+id+")";
...
%>
   <body>
    <table width="667" border="0" align="center" >
      <tr>
        <td width="657" height="116" background="../images/333.gif">      <h1 align="center" class="style12">权限管理系统</h1>      <p align="center" class="style10"> --角色权限管理</p></td></tr>
    </table>
  <form action="../Common/FormReceiveJSP_forRight.jsp?choose=7" method="post" name="form1">
    <input type="hidden" name="id" value=<%=id%>>
    <input type="hidden" name="type" value="3">
    <div align="center">
      <p class="style30">当前角色:<%=rolename[0][0]%></p>
      <table width="383" border="0" bgcolor="#C4CAE1">
        ...
        <tr>
          <td width="154" height="47"><div align="center">
            <p align="left"><strong>角色没有权限的功能</strong></p>
          </div></td>
          <td width="53">&nbsp;</td>
          <td width="154"><div align="center">
            <p align="left"><strong>角色拥有权限的功能</strong></p>
          </div></td>
        </tr>
        <tr>
